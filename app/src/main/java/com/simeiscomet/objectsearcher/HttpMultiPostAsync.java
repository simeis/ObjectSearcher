 ...
 */
public abstract class HttpMultiPostAsync extends AsyncTask<String, Integer, Boolean> implements DialogInterface.OnCancelListener {
    ...
    abstract protected void onSuccess( Boolean result );
